...
K_K2S = Vertex("K_K2S",0, 0, 12, 7, K, K2S)  # Katipu LaVista to Katipunan-FDRosa-URd Intersec
...
K2N_K = Vertex("K2N_K",0, 0, 12, 7, K2N, K)  # Road from Katip2 to Katip1
...
K2S_K2N = Vertex("K2S_K2N",0, 0, 5, 7, K2N, Uturn)  # Katip2 Uturn
K2N_K2S = Vertex("K2N_K2S",0, 0, 5, 7, K2N, Uturn)  # Katip2 Uturn
K2S_K3 = Vertex("K2S_K3",0, 0, 12, 7, K2S, K3)  # Katip2 to Katip3(Aurora)
...
K3_K2N = Vertex("K3_K2N",0, 0, 12, 7, K3, K2N)  # K3 to K2 Northbound
...
def helper_function(phase_data,diksyonaryo):
    ...
    K2N_K.car_num += int(5*(int(diksyonaryo["katip_m_u_nb_0_count"]/6)))
    K2N_K.car_num += int(5*(int(diksyonaryo["katip_m_l_nb_0_count"]/6)))
    # Mid Katipunan to Thornton
    K2N_TDrive.car_num += int(diksyonaryo["katip_m_u_nb_0_count"]/6)
    K2N_TDrive.car_num += int(diksyonaryo["katip_m_l_nb_0_count"]/6)
...
####B. Gonzales Divide2x
    ...
    Gonza_K.car_num = divide_gonza
    Gonza_K2S.car_num = divide_gonza
    random_number = random.randint(1, 2)
    if random_number == 1:
...
######## F.delaRosa Divide2x
    ...
    if phase == "phase 1":
        if intersec == 0:
            ...
            if (K2S_K3.car_num <= 25 and K3_K2N.car_num <= 25 and K3_URd.car_num <= 25):
                past_phases[0] = x
                return x
            elif (past_phases[2] == 25 and past_phases[4] == 25 and past_phases[6] == 25):
                return int(160)
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (K_K2S.car_num <= 25 and K2N_K.car_num <= 25 and K2N_TDrive.car_num <= 25):
                past_phases[1] = x
                return x
            elif (past_phases[3] == 25 and past_phases[5] == 25 and past_phases[7] == 25):
                return int(160)
        ...
        if intersec == 0:
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (URd_K3.car_num <= 12 and FDRosa_K2N.car_num <= 12 and FDRosa_K3.car_num <= 12 and FDRosa_URd.car_num <= 12):
                past_phases[2] = x
                return x
            elif (past_phases[0] == 25 and past_phases[4] == 25 and past_phases[6] == 25):
                return int(75)
            past_phases[2] = optimization_loop25(3)
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (Gonza_K.car_num <= 25 and Gonza_K2S.car_num <= 25):
                past_phases[3] = x
                return x
            elif (past_phases[1] == 25 and past_phases[5] == 25 and past_phases[7] == 25):
                return int(75)
            past_phases[3] = optimization_loop2(3)
        ...
        if intersec == 0:
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (URd_K3.car_num <= 25 and URd_K2N.car_num <= 25):
                past_phases[4] = x
                return x
            elif (past_phases[0] == 25 and past_phases[2] == 25 and past_phases[6] == 25):
                return int(70)
            past_phases[4] = optimization_loop3(3)
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (K_Uturn.car_num <= 25 and TDrive_K2S.car_num <= 25 and TDrive_K.car_num <= 25):
                past_phases[5] = x
                return x
            elif (past_phases[1] == 25 and past_phases[3] == 25 and past_phases[7] == 25):
                return int(70)
            past_phases[5] = optimization_loop35(3)
        ...
        if intersec == 0:
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (K2S_URd.car_num <= 12 and K2S_K2N.car_num <= 12 and K2S_K3.car_num <= 12):
                past_phases[6] = x
                return x
            elif (past_phases[0] == 25 and past_phases[2] == 25 and past_phases[4] == 25):
                return int(80)
            past_phases[6] = optimization_loop4(3)
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (K_Uturn.car_num <= 12 and K_K2S.car_num <= 12 and K_TDrive.car_num <= 12):
                past_phases[7] = 25
                return 25
            elif (past_phases[1] == 25 and past_phases[3] == 25 and past_phases[5] == 25):
                return int(80)
            past_phases[7] = optimization_loop4(3)
