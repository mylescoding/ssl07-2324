...
######## F.delaRosa Divide2x
    ...
    if phase == "phase 1":
        if intersec == 0:
            ...
            if (K2S_K3.car_num <= 12 and K3_K2N.car_num <= 12 and K3_URd.car_num <= 12):
                past_phases[0] = x
                return x
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (K_K2S.car_num <= 12 and K2N_K.car_num <= 12 and K2N_TDrive.car_num <= 12):
                past_phases[1] = x
                return x
        ...
        if intersec == 0:
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (Gonza_K.car_num <= 12 and Gonza_K2S.car_num <= 12):
                past_phases[3] = x
                return x
        ...
        if intersec == 0:
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (URd_K3.car_num <= 12 and URd_K2N.car_num <= 12):
                past_phases[4] = x
                return x
            ...
            for i in range(len(Roads)):
                if Roads[i].busy == 1: 
                    print(f"Number of cars in", Roads[i].name, ":", Roads[i].car_num)
            if (K_Uturn.car_num <= 20 and TDrive_K2S.car_num <= 12 and TDrive_K.car_num <= 12):
                past_phases[5] = x
                return x
