...
######## F.delaRosa Divide2x
    ...
    if phase == "phase 1":
        ...
        #     return int(160)
        if (K_K2S.car_num <= 20 and K2N_K.car_num <= 20 and K2N_TDrive.car_num <= 20 and K2S_K3.car_num <= 20 and K3_K2N.car_num <= 40 and K3_URd.car_num <= 20):
            past_phases[0] = x
            return x
        ...
        if (past_phases[0] == 25 and past_phases[1] == 25 and past_phases[3] == 25):
            return int(75)
        if (TDrive_K2S.car_num <= 15 and TDrive_K.car_num <= 15 and URd_K3.car_num <= 15 and URd_K2N.car_num <= 15):
            past_phases[2] = x
            return x
        ...
        if (past_phases[0] == 25 and past_phases[1] == 25 and past_phases[2] == 25):
            return int(70)
        if (K_Uturn.car_num <= 25 and K_K2S.car_num <= 100 and K_TDrive.car_num <= 25 and K2S_URd.car_num <= 25 and K2S_K2N.car_num <= 25 and K2S_K3.car_num <= 25):
            past_phases[3] = x
            return x
